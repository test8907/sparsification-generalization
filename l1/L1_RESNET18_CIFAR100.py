...
address ='./output/RESNET_CIFAR100_opt/'
...
train_dataset = torchvision.datasets.CIFAR100(root='/home/sda/zhouqin/sparity/data/CIFAR100', train=True, download=True, transform=train_transform)
...
test_dataset = torchvision.datasets.CIFAR100(root='/home/sda/zhouqin/sparity/data/CIFAR100', train=False, download=True, transform=val_transform)
